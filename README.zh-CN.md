...
![桌面浏览器视图](docs/assets/desktop-wide.png)

移动端浏览器视图：

| 对话列表 | 审批卡片 |
| --- | --- |
| ![移动端对话列表](docs/assets/mobile-thread-list.jpeg) | ![移动端审批卡片](docs/assets/mobile-approval.jpeg) |

| 插件选择 | 技能选择 | 套餐用量 |
| --- | --- | --- |
| ![移动端插件选择](docs/assets/mobile-plugin-picker.jpeg) | ![移动端技能选择](docs/assets/mobile-skill-picker.jpeg) | ![移动端套餐用量](docs/assets/mobile-usage.jpeg) |
