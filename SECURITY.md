...
- Use `--readonly` when web input is not needed.
...
This project depends on Codex Desktop local files and private IPC behavior. These are not public compatibility contracts. Future Codex Desktop versions may break or change behavior in ways that affect security, sync, or browser-to-Codex controls.
